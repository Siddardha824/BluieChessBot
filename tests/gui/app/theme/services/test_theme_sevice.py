...
class TestThemeService:
    ...
    def theme_service(self):
        """Fixture to provide a fresh ThemeService instance."""
        return ThemeService()

    @pytest.fixture
    def mock_qss_file(self, tmp_path):
        """Fixture to write a temporary placeholder QSS template."""
    ...
    @pytest.fixture
    def test_theme(self):
        """Fixture to provide a minimal ThemeState for tests."""
        return ThemeState(
            name="space_test",
            bg_window="#121212",
            bg_base="#181818",
    ...
    def test_apply_stylesheet_success(self, theme_service, test_theme, mock_qss_file, qtbot):
    ...
    def test_apply_stylesheet_app_not_running(self, theme_service, test_theme, mock_qss_file):
        ...
        with patch("gui.app.theme.services.theme_sevice.QApplication.instance") as mock_instance:
