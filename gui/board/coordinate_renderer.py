# gui/board/coordinate_renderer.py
...
class CoordinateRenderer:
    ...
    def draw(self, painter: QPainter, context: "RenderContext") -> None:
        ...
        Uses separate optimized loops (16 iterations instead of 64 nested iterations).
        """
        ...
        if self._font is None or self._font.families()[0] != theme.font_family or self._font.pointSize() != theme.font_size:
            self._font = QFont(theme.font_family, theme.font_size, QFont.Weight.Bold)
        ...
        for row in range(8):
            ...
            text_color = theme.text_on_light if is_light else theme.text_on_dark
