...
Bitboard attacksTo(const Board& board, Square sq, Side attackerSide)
{
    ...
    Bitboard attackingPawns =
        pawnAttacks[toIndex(oppositeSide)][toIndex(sq)] &
    ...
    Bitboard attackingKings =
        kingAttacks[toIndex(sq)] &
    ...
    Bitboard attackingBishops =
        bAttacks & (board.getPieceBitboard(attackerSide == Side::WHITE ? Piece::B : Piece::b) |
    ...
    Bitboard attackingRooks =
        rAttacks & (board.getPieceBitboard(attackerSide == Side::WHITE ? Piece::R : Piece::r) |
                    board.getPieceBitboard(attackerSide == Side::WHITE ? Piece::Q : Piece::q));
